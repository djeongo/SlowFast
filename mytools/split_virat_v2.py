...
for split in dfs_annotations_map.keys():
    ...
    train_annotation_path = f'{ANNOTATION_OUTPUT_PATH}/{dfs_annotations_map[split]["csv_annotations"]}'
    print("Writing "+train_annotation_path)
    df.to_csv(train_annotation_path, sep=',', index=False, quoting=csv.QUOTE_NONE, header=False)
...
# train_annotation_path = f'{ANNOTATION_OUTPUT_PATH}/train_annotation.csv'
...
# print("Writing "+train_annotation_path)
# pd.concat(df_annotations_train).to_csv(train_annotation_path, sep=',', index=False, quoting=csv.QUOTE_NONE, header=False)
